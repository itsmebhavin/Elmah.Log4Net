...
namespace Elmah.Log4Net
{
    public class ElmahLog4NetAppender : log4net.Appender.AppenderSkeleton
    {
        private readonly static Type _DeclaringType = typeof(ElmahLog4NetAppender);
